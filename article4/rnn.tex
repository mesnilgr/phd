...
The first generative model, used by both the AT\&T CHRONUS system (\cite{rnn31}) and the
...
While (\cite{rnn15, rnn24}) suggest initializing the embedding vectors with unsupervised
