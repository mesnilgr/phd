...
\item[2014] \hfill \\
\begin{description}
\item \uline{Grégoire Mesnil}, Yann Dauphin, Kaisheng Yao, Yoshua Bengio, Li Deng, Dilek Hakkani-Tur, Xiaodong He, Larry Heck, Gokhan Tur, Dong Yu and Geoffrey Zweig {\bf Using Recurrent Neural Networks for Slot Filling in Spoken Language Understanding} (2014) Transactions on Audio, Signal and Language Processing IEEE, submitted.
\vspace{0.1cm}
...
(2014) Lecture Notes in Advances in Intelligent and Soft Computing, Springer-Verlag
\vspace{0.1cm}
\item Yelong Shen, Xiaodong He, Jianfeng Gao, Li Deng and \uline{Grégoire Mesnil}
